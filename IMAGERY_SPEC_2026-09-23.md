...
- **White-vinyl sticker contour, approved 2026/09/26:** The five single sticker masters and the sticker sheet use near-black `#0B0B0D` lettering and FÆBRIQ wordmarks. Each individual sticker has one connected, solid-white, near-symmetrical organic contour around its full lockup, built from softly overlapping rounded bands. It has a transparent canvas outside it and no transparent interior voids. It must never be a white square, a literal character outline, a sharp badge, or separate sticker pieces. The full-drop product remains a rectangular sticker sheet. Keep the six-color Pride Circuit bar unchanged. Do not resize, re-space, redraw, or add a black background.
