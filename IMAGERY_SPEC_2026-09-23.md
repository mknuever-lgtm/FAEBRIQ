...
- Slot 1: `Studio product photo of a single white kiss-cut vinyl sticker, flat on a dark textured surface. The near-black attached design has one connected contour-cut white silhouette around the full lockup, a six-block rainbow stripe, and the small FÆBRIQ wordmark underneath, fully legible, slight gloss. No square backing and no separate sticker pieces.`
