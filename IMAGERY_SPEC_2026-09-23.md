...
- **Print system (set 2026/09/25, supersedes every earlier lockup):** Inter SemiBold, white. Line 2 at 55 to 90% of line 1's font size, set per design in `tools/make_print_system.py` (404 0.55, Code It 0.85, Off The Clock 0.72, Deploying 0.75, Not A Bug 0.80, Please Hold 0.58). A flat six-block rainbow pride stripe under the text, 1.35x the widest text line. Files: `assets/print-art/system-2026-09-25/`, generated by `tools/make_print_system.py`.
- **Wordmark:** FÆBRIQ under the stripe on stickers and the tote only. Tees, hoodie and crewneck carry no wordmark on the chest; they get `wordmark-faebriq-sleeve.png` (FÆBRIQ alone, no stripe) horizontal at the bottom of the left sleeve. The cap front uses `logo-faebriq-1p35.png` (FÆBRIQ over the stripe).
...
- **Retired 2026/09/25:** every print file outside `system-2026-09-25/` (Bodoni serif masters, the v3 404, cap v2/v3, `sticker-final-system-2026-08-27/`) and the 2026-09-24 product image set.
