...
- Brand: queer-coded dark-tech merch. Voice: dry, deadpan, terminal wit.
  ...
  is 100% size, line 2 is 75-85% of line 1. Bar is 1.35x the WIDEST text in
  the design (final, non-negotiable, every design: sticker, tee, crewneck,
  hoodie, tote, cap), not tied to a specific element like the small mark.
