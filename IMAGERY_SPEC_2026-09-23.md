...
- **White-vinyl sticker correction, approved 2026/09/26:** The five single sticker masters and the sticker sheet use near-black `#0B0B0D` lettering and FÆBRIQ wordmarks. Each individual sticker has one connected, solid-white contour-cut backing around its full lockup, with a transparent canvas outside it and no transparent interior voids. It must never be a white square or separate sticker pieces. The full-drop product remains a rectangular sticker sheet. Keep the six-color Pride Circuit bar unchanged. Do not resize, re-space, redraw, or add a black background.
...
- Slot 1: `Studio product photo of a single white kiss-cut vinyl sticker, flat on a dark textured surface. The near-black attached design has one connected solid-white contour-cut silhouette around the full lockup, a six-block rainbow stripe, and the small FÆBRIQ wordmark underneath, fully legible, slight gloss. No square backing, no separate sticker pieces, and no transparent interior holes.`
