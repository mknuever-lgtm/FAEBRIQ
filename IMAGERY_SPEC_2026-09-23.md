...
- **Print system (set 2026/09/25, supersedes every earlier lockup):** Inter SemiBold, white. Line 2 at 75% of line 1's font size. A flat six-block rainbow pride stripe under the text, 1.35x the widest text line. Files: `assets/print-art/system-2026-09-25/`, generated by `tools/make_print_system.py`.
