# FÆBRIQ Legal Policies

Four store policies, written for FÆBRIQ's print-on-demand model. Each file is ready to paste into **Shopify Admin → Settings → Legal**, replacing the generic Shopify template.

| Policy | File | Shopify field |
| --- | --- | --- |
| Privacy Policy | [privacy-policy.md](./privacy-policy.md) | Privacy policy |
| Refund Policy | [refund-policy.md](./refund-policy.md) | Refund policy |
