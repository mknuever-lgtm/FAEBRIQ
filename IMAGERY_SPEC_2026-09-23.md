...
- **Wordmark (set 2026/09/23):** the sans FÆBRIQ, middle version in `assets/print-art/reference/wordmark-reference-2026-09-23.jpg`, over a six-block bar with no gaps at 1.35x the wordmark width. Wordmark only: phrase lockups keep their serif.
