...
- **White-vinyl sticker contour and hierarchy, approved 2026/09/26:** The five single sticker masters and the sticker sheet use near-black `#0B0B0D` lettering and FÆBRIQ wordmarks. On every individual sticker, line 1's Bodoni cap height is **1.25x** line 2's cap height. This is deliberately modest, not the former 2x to 3x hero hierarchy. Each individual sticker has one connected, solid-white, near-symmetrical organic contour around its full lockup, built from softly overlapping rounded bands. It has a transparent canvas outside it and no transparent interior voids. It must never be a white square, a literal character outline, a sharp badge, or separate sticker pieces. The full-drop product remains a rectangular sticker sheet, regenerated with the same 1.25x type hierarchy. Keep the six-color Pride Circuit bar unchanged. Do not add a black background.
...
- Slot 1: `Studio product photo of a single white kiss-cut vinyl sticker, flat on a dark textured surface. The near-black attached design has one connected, near-symmetrical, solid-white organic contour around the full lockup, a six-block rainbow stripe, and the small FÆBRIQ wordmark underneath, fully legible, slight gloss. No square backing, literal character outline, separate sticker pieces, or transparent interior holes.`
